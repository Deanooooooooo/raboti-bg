...
- **Role wordmarks:** Vdiga, Pishe and Pomaga use their owner-supplied transparent wordmarks as restrained identity anchors. Use the dark variants on white/pale fields and the light variants over portraits, dark fields or saturated color. Size every context by optical width, never by a shared height: 96px in the service strip, 110px in the homepage demo, 150px desktop / 130px mobile over portraits, and 180px desktop / 150px mobile in agent-page heroes. Preserve each native aspect ratio within those bounds. Pishe's light foreground alpha is normalized to solid white while retaining the blue accent. One identifying mark per role-focused region is enough.
